...
const SecondJoystick = ({ isPressed, setIsPressed }: JoystickProps) => {
  ...
  const getAnimation = (isPressed: ClickType | null) => {
    if (!isPressed) return "";
    if (isPressed === "up") {
      return styles["joystick-container-press-up"];
    } else if (isPressed === "down") {
      return styles["joystick-container-press-down"];
    } else if (isPressed === "left") {
      return styles["joystick-container-press-left"];
    } else if (isPressed === "right") {
      return styles["joystick-container-press-right"];
    }
  };


  return (
    <div className={`${styles["joystick-container"]} ${getAnimation(isPressed)}`}>
      <button
        className={`${styles["joystick-button"]}  ${isPressed === "up" ? styles["pressed"] : ""}`}
      ...
      <button
        className={`${styles["joystick-button"]} ${isPressed === "left" ? styles["pressed"] : ""}`}
      ...
      <button
        className={`${styles["joystick-button"]} ${isPressed === "right" ? styles["pressed"] : ""}`}
      ...
      <button
        className={`${styles["joystick-button"]} ${isPressed === "down" ? styles["pressed"] : ""}`}
